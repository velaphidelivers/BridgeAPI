...
public class RoutingMiddleware2
{
    ...
    public RoutingMiddleware2(RequestDelegate next, IAllowedUrls allowedUrls, IConfiguration configuration, ITokenService tokenService)
    {
